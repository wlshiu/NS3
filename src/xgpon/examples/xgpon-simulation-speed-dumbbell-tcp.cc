...
NS_LOG_COMPONENT_DEFINE ("XgponSimulationSpeedDumbbellTcp");
...
main (int argc, char *argv[])
{
  ...
  if(p_verbose)
  {
    xgponHelper.EnableAsciiAll("xgpon-simulation-speed-dumbbell-tcp-ascii");
    xgponHelper.EnablePcapAll("xgpon-simulation-speed-dumbbell-tcp-pcap");
  }
