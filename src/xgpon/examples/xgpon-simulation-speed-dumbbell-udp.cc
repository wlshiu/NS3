...
NS_LOG_COMPONENT_DEFINE ("XgponSimulationSpeedDumbbellUdp");
...
main (int argc, char *argv[])
{
  ...
  if(p_verbose)
  {
    xgponHelper.EnableAsciiAll("xgpon-simulation-speed-dumbbell-udp-ascii");
    xgponHelper.EnablePcapAll("xgpon-simulation-speed-dumbbell-udp-pcap");
  }
